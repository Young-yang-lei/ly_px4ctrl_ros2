...
namespace uav_utils {
  ...
  Eigen::Matrix < typename Derived::Scalar, 3,
  3 > ypr_to_R(const Eigen::DenseBase < Derived > &ypr) {
    ...
    Eigen::Matrix < typename Derived::Scalar, 3, 3 > Rz = Eigen::Matrix < typename Derived::Scalar,
    3, 3 > ::Zero();
    ...
    Eigen::Matrix < typename Derived::Scalar, 3, 3 > Ry = Eigen::Matrix < typename Derived::Scalar,
    3, 3 > ::Zero();
    ...
    Eigen::Matrix < typename Derived::Scalar, 3, 3 > Rx = Eigen::Matrix < typename Derived::Scalar,
    3, 3 > ::Zero();
  ...
  template < typename Derived >
  Eigen::Quaternion < typename Derived::Scalar > ypr_to_quaternion(
    const Eigen::DenseBase < Derived > &ypr) {
    EIGEN_STATIC_ASSERT_FIXED_SIZE(Derived);
    EIGEN_STATIC_ASSERT(
      Derived::RowsAtCompileTime == 3,
      THIS_METHOD_IS_ONLY_FOR_MATRICES_OF_A_SPECIFIC_SIZE);
  ...
  template < typename Derived >
  Eigen::Matrix < typename Derived::Scalar, 3, 3 > get_skew_symmetric(
  ...
  template < typename Derived >
  Eigen::Matrix < typename Derived::Scalar, 3, 1 > from_skew_symmetric(
    ...
    assert(
      v.isApprox(
        Eigen::Matrix < typename Derived::Scalar, 3, 1 > (-M(1, 2), M(0, 2), -M(
          0,
          1))));
